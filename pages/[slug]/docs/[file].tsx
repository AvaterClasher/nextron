...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  try {
    ...
    submit({
      message: `Hey I'm Nextron bot. There's an error with the ${siteData?.siteName}. While building the docs for docs/${filename}.md, the bundler threw an error. Please check the error`,
      error: error.message,
